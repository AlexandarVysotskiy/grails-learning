...
<body onload="">
<div>
    <g:link controller="user" action="addNewUser">
...
<div>
    <table>
        <g:each var="u" in="${users}">
            <tr>
                ...
                <td>
                    <g:link controller="user" action="editUser" params="${params}">
    ...
    <div style="margin: 2rem 0 0 0">
        <g:paginate params="${params}" offset="0" max="5" controller="user" action="search"
                    total="${userTotal?: 0}"/>
    </div>
</div>
</body>
